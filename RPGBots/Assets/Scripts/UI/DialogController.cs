...
public class DialogController : MonoBehaviour
{
	...
	void RefreshView()
	{
        System.Text.StringBuilder storyTextBuilder = new StringBuilder();
		while (_story.canContinue)
		{
			HandleTags();//para que lo cheque cada que avance
    ...
    void HandleTags()
    {
        ...
        {
			if (tag.StartsWith("E."))//aquí es el de #OpenDoor the ink
            {
